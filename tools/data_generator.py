...
class DataGenerator:
    def __init__(self, seed: Optional[int] = None):
        ...
        self.base_time_ms = 1_700_000_000_000 if seed is not None else int(time.time() * 1000)
...
def parse_args():
    ...
    parser.add_argument("--seed", type=int, default=os.environ.get("SEED"), help="Integer random seed; also supports SEED env var")
...
def main():
    ...
    if seed is None:
        print("Generating test data with non-deterministic seed...")
    else:
